    ...
    function (element) {
      ...
      it("should inherit", function (done) {
        setTimeout(() => {
          ...
          // On root element
          expect(c(element().querySelector("div")).backgroundColor).toBe(
            "rgb(255, 0, 0)"
          );
          expect(c(element().querySelector("span")).backgroundColor).toBe(
            "rgb(0, 128, 0)"
          );
      ...
      it('should not inherit tagged "local"', function (done) {
        setTimeout(() => {
          ...
          // On root element
          expect(c(element().querySelector("div")).color).toBe(
            "rgb(0, 128, 0)"
          );
          expect(c(element().querySelector("span")).color).toBe(
            "rgb(138, 43, 226)"
          );
